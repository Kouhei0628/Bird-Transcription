...
export function Ja() {
  return (
    <p className={styles.notetxt}>
      ...
      <Bracket />
      )はどの鳴き声も当てはめることができることを表しています。これらの記号は複数組み合わせて使用されることがあります。そしてこれらはあくまで私による解釈であり正解となるものはありません。また地域差、個体差、年齢差など様々な条件により、提示した解釈と異なる場合があります。
      それぞれの記号が書かれたボードの下に示すように、全ての鳥は学名で記されています。もし俗名を知りたい方は
