...
export function En() {
  return (
    <p>
      In this work, I reproduced the richness of the musical aspect of birdsong
      by extracting the characteristics of each sound while listening to them
      and defining visual symbols unique to birds. In this exhibition, dozens of
      bird calls are reproduced on the left and right panels, and on the front
      panel, you can see them all gathered together to ensemble.
      <br />
